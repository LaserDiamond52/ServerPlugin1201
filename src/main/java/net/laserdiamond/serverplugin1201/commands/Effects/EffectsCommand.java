package net.laserdiamond.serverplugin1201.commands.Effects;
...
public class EffectsCommand implements CommandExecutor, TabExecutor {
    ...
    public EffectsCommand(ServerPlugin1201 plugin) {
        this.plugin = plugin;
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (sender.hasPermission("serverplugin1201.effects")) {
            if (args.length == 0) {
    ...
    public @Nullable List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (sender.hasPermission("serverplugin1201.effect")) {
