package net.laserdiamond.serverplugin1201.items.armor.Blaze.Config;
...
public class BlazeArmorConfig implements GetVarFile {
    ...
    public BlazeArmorConfig(ServerPlugin1201 plugin, String fileName) {
        this.plugin = plugin;
        this.fileName = fileName;
        folders = new File(plugin.getDataFolder() + File.separator + "items" + File.separator + "armor" + File.separator + "blaze");
