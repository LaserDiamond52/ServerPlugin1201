...
public class PluginItemRarity implements PersistentDataType<String, PluginItemRarity.Rarity> {
    ...
    @Override
    public @NotNull PluginItemRarity.Rarity fromPrimitive(@NotNull String primitive, @NotNull PersistentDataAdapterContext context) {
