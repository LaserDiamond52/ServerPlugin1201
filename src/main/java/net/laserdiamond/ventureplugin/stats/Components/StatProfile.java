...
public record StatProfile(Stats stats, MainhandStats mainhandStats, ArmorStats armorStats, DamageStats damageStats, DefenseStats defenseStats, LootStats lootStats, EnchantStats enchantStats, ArmorTrimStats armorTrimStats, TuningProfile tuningProfile, SkillsProfile skillsProfile, PotionStats potionStats) {
