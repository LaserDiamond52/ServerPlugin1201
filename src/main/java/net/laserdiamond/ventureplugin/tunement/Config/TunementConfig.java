package net.laserdiamond.ventureplugin.tunement.Config;

import net.laserdiamond.ventureplugin.VenturePlugin;
import net.laserdiamond.ventureplugin.util.File.FileLoaderSaver;
...
public class TunementConfig implements FileLoaderSaver {
    ...
    public TunementConfig(VenturePlugin plugin, String fileName) {
        this.plugin = plugin;
