...
public enum MenuItem {
    ...
    FORTUNE_STAT (Material.EMERALD, ChatColor.DARK_GREEN + "Fortune " + StatSymbols.FORTUNE.getSymbol() + ChatColor.GRAY + " and" + ChatColor.GREEN + " Luck " + StatSymbols.LUCK.getSymbol(), "fortune_and_luck_stat"),
    ...
    LUCK_MORE (Material.EMERALD, ChatColor.GREEN + "Luck " + StatSymbols.LUCK.getSymbol(), "luck_info"),
