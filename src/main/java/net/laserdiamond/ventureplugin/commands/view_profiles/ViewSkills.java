package net.laserdiamond.ventureplugin.commands.view_profiles;
...
public class ViewSkills implements CommandExecutor, InventoryClicker {
    ...
    private Inventory skillProgressInventory(Player player, SkillsExpGainEvent.Skill skill, SkillProgressInvSection section)
    {
        ...
        if (section == SkillProgressInvSection.SECTION_1)
        {
            ...
            for (int i = 0; i < 26; i++)
            {
                VentureItemBuilder progressItem = skillProgressItem.skillProgressItem(i, skillsProfile);
    ...
    static
    {
        // Slot 0 for section 1 is for info item
        ...
        // Slot 0 for section 2 is for info item
