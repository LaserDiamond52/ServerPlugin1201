package net.laserdiamond.ventureplugin.commands.SkillsEdit;
        ...
        if (sender.hasPermission(Permissions.EDIT_SKILLS.getPermission()))
        {
            switch (args.length)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    sender.sendMessage(ChatColor.RED + "Please specify a skill to modify");
                    break;
                case 3:
    ...
    private void resetSkillExp(Player target, SkillsExpGainEvent.Skill skill)
    {
        ...
        switch (skill)
        {
            ...
            case MINING -> {
                ...
                lootStats.setBonusOreLoot(lootStats.getBonusOreLoot() - skillsReward.getMiningFortuneBonus());
            ...
            case FORAGING -> {
                ...
                lootStats.setBonusWoodLoot(lootStats.getBonusWoodLoot() - skillsReward.getForagingFortuneBonus());
            ...
            case FARMING -> {
                ...
                lootStats.setBonusFarmingLoot(lootStats.getBonusFarmingLoot() - skillsReward.getFarmingFortuneBonus());
